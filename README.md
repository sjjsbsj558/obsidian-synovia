...
This project is released under the MIT License. Redistribution and modified versions must retain the copyright notice and the license notice in [`LICENSE`](LICENSE). Dependencies retain their own licenses.
